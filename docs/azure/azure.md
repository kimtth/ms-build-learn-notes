...
1. [Describe core Azure architectural components](https://learn.microsoft.com/en-us/training/modules/azure-architecture-fundamentals)
1. [Build a cloud governance strategy on Azure](https://learn.microsoft.com/en-us/training/modules/build-cloud-governance-strategy-azure)
1. [Microsoft Cloud Adoption Framework for Azure](https://learn.microsoft.com/en-us/training/modules/microsoft-cloud-adoption-framework-for-azure)
1. [Introduction to the Microsoft Azure Well-Architected Framework](https://learn.microsoft.com/en-us/training/modules/azure-well-architected-introduction)
1. [Secure access to your applications by using Azure identity services](https://learn.microsoft.com/en-us/training/modules/secure-access-azure-identity-services)
1. [Explore Azure compute services](https://learn.microsoft.com/en-us/training/modules/azure-compute-fundamentals)
1. [Discover Azure message queues](https://learn.microsoft.com/en-us/training/modules/discover-azure-message-queue)
1. [Explore Azure networking services](https://learn.microsoft.com/en-us/training/modules/azure-networking-fundamentals)
1. [Explore Azure Storage services](https://learn.microsoft.com/en-us/training/modules/azure-storage-fundamentals)
1. [Explore Azure database and analytics services](https://learn.microsoft.com/en-us/training/modules/azure-database-fundamentals)
1. [Design governance](https://learn.microsoft.com/en-us/training/modules/design-governance)
1. [Design authentication and authorization solutions](https://learn.microsoft.com/en-us/training/modules/design-authentication-authorization-solutions)
1. [Design a solution to log and monitor Azure resources](https://learn.microsoft.com/en-us/training/modules/design-solution-to-log-monitor-azure-resources)
1. [Describe high availability and disaster recovery strategies](https://learn.microsoft.com/en-us/training/modules/describe-high-availability-disaster-recovery-strategies)
1. [Design a solution for backup and disaster recovery](https://learn.microsoft.com/en-us/training/modules/design-solution-for-backup-disaster-recovery)
1. [Design a data storage solution for non-relational data](https://learn.microsoft.com/en-us/training/modules/design-data-storage-solution-for-non-relational-data)
1. [Design a data storage solution for relational data](https://learn.microsoft.com/en-us/training/modules/design-data-storage-solution-for-relational-data)
1. [Design data integration](https://learn.microsoft.com/en-us/training/modules/design-data-integration)
1. [Design an Azure compute solution](https://learn.microsoft.com/en-us/training/modules/design-compute-solution)
1. [Design an application architecture](https://learn.microsoft.com/en-us/training/modules/design-application-architecture)
1. [Design network solutions](https://learn.microsoft.com/en-us/training/modules/design-network-solutions)
1. [Design migrations](https://learn.microsoft.com/en-us/training/modules/design-migrations)
1. [Microsoft Azure Well-Architected Framework - Cost optimization](https://learn.microsoft.com/en-us/training/modules/azure-well-architected-cost-optimization)
1. [Microsoft Azure Well-Architected Framework - Operational excellence](https://learn.microsoft.com/en-us/training/modules/azure-well-architected-operational-excellence)
1. [Microsoft Azure Well-Architected Framework - Performance efficiency](https://learn.microsoft.com/en-us/training/modules/azure-well-architected-performance-efficiency)
1. [Microsoft Azure Well-Architected Framework - Reliability](https://learn.microsoft.com/en-us/training/modules/azure-well-architected-reliability)
1. [Microsoft Azure Well-Architected Framework - Security](https://learn.microsoft.com/en-us/training/modules/azure-well-architected-security)
1. [Getting started with the Microsoft Cloud Adoption Framework for Azure](https://learn.microsoft.com/en-us/training/modules/cloud-adoption-framework-getting-started)
1. [Prepare for successful cloud adoption with a well-defined strategy](https://learn.microsoft.com/en-us/training/modules/cloud-adoption-framework-strategy)
1. [Prepare for cloud adoption with a data-driven plan](https://learn.microsoft.com/en-us/training/modules/cloud-adoption-framework-plan)
1. [Choose the best Azure landing zone to support your requirements for cloud operations](https://learn.microsoft.com/en-us/training/modules/cloud-adoption-framework-ready)
1. [Migrate to Azure through repeatable processes and common tools](https://learn.microsoft.com/en-us/training/modules/cloud-adoption-framework-migrate)
1. [Address tangible risks with the Govern methodology of the Cloud Adoption Framework for Azure](https://learn.microsoft.com/en-us/training/modules/cloud-adoption-framework-govern)
1. [Ensure stable operations and optimization across all supported workloads deployed to the cloud](https://learn.microsoft.com/en-us/training/modules/cloud-adoption-framework-manage)
1. [Innovate applications by using Azure cloud technologies](https://learn.microsoft.com/en-us/training/modules/innovate-applications-with-azure-cloud-technologies)
1. [Prepare for cloud security by using the Microsoft Cloud Adoption Framework for Azure](https://learn.microsoft.com/en-us/training/modules/cloud-adoption-framework-security)
- **Microsoft Entra ID** is the current product name for Azure Active Directory (Azure AD). Existing APIs, login URLs, cmdlets, and integrations continue to work, but new documentation should use Microsoft Entra ID. See [the Microsoft Entra ID naming guidance](https://learn.microsoft.com/en-us/entra/fundamentals/new-name).
- **Azure Blueprints (Preview)** is being retired on January 31, 2027; phased retirement began on July 31, 2026. For new governance automation, use [Bicep](https://learn.microsoft.com/en-us/azure/azure-resource-manager/bicep/overview) with Azure Policy and role assignments, and migrate existing blueprints to [Deployment Stacks or Template Specs](https://learn.microsoft.com/en-us/azure/governance/blueprints/blueprint-retirement).
- The Well-Architected Framework has five pillars: reliability, security, cost optimization, operational excellence, and performance efficiency. Use it together with the [Cloud Adoption Framework](https://learn.microsoft.com/en-us/azure/cloud-adoption-framework/overview): CAF guides organizational adoption and governance, while Well-Architected Framework guides workload design and operations.
...
- Use Bicep, Azure Policy, role assignments, and deployment stacks to define repeatable governance and standard Azure resources. Azure Blueprints is in phased retirement; prioritize migration of definitions and assignments before January 31, 2027.
...
- Bicep, Azure Policy, and deployment stacks provide the current approach for repeatable infrastructure and governance.
...
- [Azure Blueprints retirement and migration guidance](https://learn.microsoft.com/en-us/azure/governance/blueprints/blueprint-retirement)
...
<img src="../../assets/images/scales.png" alt="scale" width="300"/>

Security layers

<img src="../../assets/images/security-layers.png" alt="scale" width="300"/>

Shared security responsibility

<img src="../../assets/images/shared-responsibilities.png" alt="scale" width="300"/>
...
- What is authorization?
  ...
  <img src="../../assets/images/2-id-card-access.png" alt="scale" width="300"/>

- How does Microsoft Entra ID compare to Active Directory?

  Active Directory is related to Microsoft Entra ID, but they have some key differences.
...
3. Application management
  ...
  You can manage your cloud and on-premises apps by using Microsoft Entra ID. Features like Application Proxy, SaaS apps, the My Apps portal (also called the access panel), and single sign-on provide a better user experience.
...
- How can I connect Active Directory with Microsoft Entra ID?

  There are a few ways to connect your existing Active Directory installation with Microsoft Entra ID. A common method is to use Microsoft Entra Connect Sync.

  Microsoft Entra Connect Sync synchronizes user identities between on-premises Active Directory and Microsoft Entra ID. It synchronizes changes between both identity systems, so you can use features like SSO, multifactor authentication, and self-service password reset under both systems. Self-service password reset prevents users from using known compromised passwords.

  <img src="../../assets/images/3-azure-ad-connect.png" alt="scale" width="300"/>
...
- What's multifactor authentication?
  ...
  Microsoft Entra multifactor authentication supports these identity and Microsoft 365 scenarios:

    1. Microsoft Entra ID
    1. Microsoft 365
- What's Conditional Access?

  Conditional Access is a Microsoft Entra capability that allows or denies access to resources based on identity signals. These signals include who the user is, where the user is, and what device the user is requesting access from.
...
1. Block access from untrusted sources, such as access from unknown or unexpected locations.
  ...
  Conditional Access requires the appropriate Microsoft Entra ID licensing, such as Microsoft Entra ID P1 or P2. Verify current licensing requirements in Microsoft Learn before deployment.
...
- Microsoft Entra ID is a cloud-based identity and access management service that controls access to apps and resources based on business requirements.
- Microsoft Entra multifactor authentication provides additional security for identities by requiring two or more elements to fully authenticate. In general, multifactor authentication can include something the user knows, something the user has, and something the user is.
- Conditional Access is a Microsoft Entra capability that allows or denies access to resources based on identity signals such as the user's location.
...
- Azure Container Apps:
  Azure Container Apps is a serverless platform for containerized APIs, background processing, event-driven workloads, and microservices. It supports scaling, revisions, traffic splitting, jobs, and KEDA-based triggers without managing Kubernetes directly.
...
- Use Durable Functions when an event-driven workflow needs durable state, checkpoints, retries, recovery, or long-running orchestration. For AI-augmented serverless workloads, use managed identities to connect Functions or Container Apps to Foundry, Azure AI Search, and data services; require human confirmation before consequential actions.
...
1. As a solution architect/developer, **consider using Service Bus queues** when:
...
All data transfer is encrypted inside a private tunnel as it crosses the internet. You can deploy only one VPN gateway in each virtual network, but you can use one gateway to connect to multiple locations, which includes other virtual networks or on-premises datacenters.
  ...
  <img src="../../assets/images/vpngateway.png" alt="vng" width="500"/>
...
1. The following diagram shows this combination of resources and their relationships to help you better understand what's required to deploy a VPN gateway.
    ...
    <img src="../../assets/images/resource-requirements-for-vpn-gateway.png" alt="rr-vng" width="450"/>
...
1. Fault-tolerant configuration.
    ...
    Active/Standby and Active/Active
      ...
      <img src="../../assets/images/active-standby.png" alt="act-std" width="450"/>

- Azure ExpressRoute

There are several benefits to using ExpressRoute as the connection service between Azure and on-premises networks.

<img src="../../assets/images/azure-expressroute.png" alt="act-std" width="450"/>
...
<img src="../../assets/images/azure-connectivity-models.png" alt="act-std" width="450"/>
...
1. Azure Cosmos DB
1. Azure Cosmos DB is a globally distributed NoSQL database service with multiple APIs, including NoSQL, MongoDB, Cassandra, Gremlin, and Table. Choose the API that matches the application protocol and data model; use the **Azure Cosmos DB for NoSQL** terminology for the native JSON and SQL-query API.
1. Azure Cosmos DB supports flexible JSON data models and horizontal partitioning. Model data around access patterns and select the partition key before committing a production schema.
...
1. Use Azure Database for PostgreSQL Flexible Server for new deployments. It provides a managed PostgreSQL service with configurable compute, storage, networking, high availability, and maintenance controls.
1. Azure Cosmos DB for PostgreSQL is on a retirement path and isn't recommended for new projects. For new distributed PostgreSQL workloads, use [Azure Database for PostgreSQL Elastic Clusters](https://learn.microsoft.com/en-us/azure/postgresql/elastic-clusters/concepts-elastic-clusters), which provides Citus-based row- and schema-based sharding on Flexible Server. Use the [current migration guidance](https://learn.microsoft.com/en-us/azure/cosmos-db/postgresql/migrate-postgresql-elastic-cluster) for existing clusters rather than relying on a retirement date that could change.
...
1. Azure HDInsight
1. Azure HDInsight is a managed service for selected open-source analytics frameworks. Confirm current service availability and workload fit before selecting it; for many modern lakehouse workloads, evaluate Microsoft Fabric, Azure Databricks, or Azure Synapse Analytics.
1. Azure Databricks
...
1. Azure Data Lake Analytics retired on February 29, 2024. For analytics workloads, choose Azure Synapse Analytics or Microsoft Fabric; evaluate Azure Databricks for Spark-centric engineering and Azure Data Factory for orchestration and data movement rather than treating it as a U-SQL replacement.

## Design governance

- A typical Azure hierarchy has four levels: management groups, subscriptions, resource groups, and resources.
- <img src="../../assets/images/governance-strategies.png" alt="act-std" width="450"/>
...
1. Resources are instances of services that you create. For example, virtual machines, storage, and SQL databases.
    ...
    <img src="../../assets/images/resource-tags.png" alt="act-std" width="450"/>
...
1. Azure Blueprints is in phased retirement and retires January 31, 2027. Use Bicep, deployment stacks or template specs, Azure Policy, and Azure RBAC for repeatable governance and infrastructure deployment.

    <img src="../../assets/images/azure-blueprints.png" alt="act-std" width="450"/>

    1. Bicep is a declarative language for deploying Azure resources. Use source control, reviews, `what-if`, and CI/CD to make infrastructure changes repeatable and auditable.
    1. Azure Policy evaluates resource configuration for compliance. Use initiatives to group related definitions and assignment scopes to apply controls across management groups, subscriptions, resource groups, or resources.
1. Landing zones
    ...
    <img src="../../assets/images/landing-zones.png" alt="act-std" width="450"/>
    ...
    1. The Azure landing zone accelerator can be deployed into the same Microsoft Entra tenant for an existing Azure architecture. Treat the accelerator as an infrastructure-as-code implementation and maintain its platform configuration through source control and a supported deployment pipeline.


## Authentication and authorization solutions

1. Identity and access management (IAM)
    1. Consider using Microsoft Entra ID. Develop with Microsoft Entra ID for a solution that combines core directory services, application access management, and identity protection in cloud or hybrid environments.
    1. Consider business-to-business requirements. Support collaboration for guest users and external partners by using Microsoft Entra B2B collaboration.
    1. Consider business-to-customer scenarios. Microsoft Entra External ID is the current direction for new customer identity scenarios. Azure AD B2C is a legacy customer-identity solution and has not been available for new customers since May 1, 2025.
1. Microsoft Entra ID also offers hybrid identity capabilities for identity management in hybrid environments.
1. Consider password hash synchronization. It synchronizes an additional protected password hash from on-premises Active Directory to Microsoft Entra ID and can help detect leaked credentials.
1. **With Microsoft Entra B2B collaboration, an external partner uses their own identity management solution.**

    <img src="../../assets/images/external-identities.png" alt="act-std" width="450"/>

1. **For new customer identity scenarios, use Microsoft Entra External ID. Existing Azure AD B2C workloads continue under their current support lifecycle, but should have an explicit modernization plan.**
    ...
    <img src="../../assets/images/application-registration.png" alt="act-std" width="450"/>

1. Microsoft Entra Conditional Access
    1. Conditional Access examines who the user is, where the user is, and from what device the user is requesting access. Based on these signals, it can allow access, enforce multifactor authentication (MFA), or deny access.
    1. Conditional Access requires the appropriate Microsoft Entra ID licensing. Verify the current license requirements before implementation.

    <img src="../../assets/images/conditions-actions.png" alt="act-std" width="450"/>
...
1. Identity Protection
    ...
    <img src="../../assets/images/user-risk-level-evaluation.png" alt="act-std" width="450"/>
    ...
    <img src="../../assets/images/risk-detections.png" alt="act-std" width="450"/>
...
1. Access reviews
    ...
    - To ensure employees and users always have the correct access, you can perform a Microsoft Entra access review: a planned review of the access needs, rights, and history of user access.
...
1. Service principals for application
    - You need to understand the two ways an app can be represented in Microsoft Entra ID: as an application object, or by a service principal.
    ...
    <img src="../../assets/images/application-service-principals.png" alt="act-std" width="450"/>
    ...
    - **There are three types of service principals that you can use for your organization: application, managed identity, and legacy.**
      ...
      1. Managed identity: This type of service principal represents a managed identity, which eliminates the need to manage credentials. Managed identities provide an identity for applications to use when connecting to resources that support Microsoft Entra authentication.
...
1. Managed identities
    ...
    - When you use managed identities, you don't need to manage application secrets for supported Azure resources. Azure handles the identity lifecycle and token issuance; grant the identity only the permissions it needs.
    - There are two types of managed identities:
      1. System-assigned: Some Azure services allow you to enable a managed identity directly on a service instance. When you enable a system-assigned managed identity, an identity is created in Microsoft Entra ID that's tied to the lifecycle of that service instance. When the resource is deleted, Azure automatically deletes the identity. By design, only that Azure resource can use that identity to request tokens from Microsoft Entra ID.
...
1. Azure Monitor
    ...
    <img src="../../assets/images/azure-monitor-source.png" alt="act-std" width="450"/>

    <img src="../../assets/images/data-sources.png" alt="act-std" width="450"/>
...
1. Azure Data Explorer
    ...
    <img src="../../assets/images/azure-data-explorer.png" alt="act-std" width="450"/>
...
1. Availability Sets
  ...
  <img src="../../assets/images/module-77-high-availability-final-01.png" alt="-" width="450"/>
...
<img src="../../assets/images/site-recovery.png" alt="-" width="450"/>
...
- Azure Storage offers two options for how your data is replicated in the primary region: locally redundant storage and zone-redundant storage.
  ...
  <img src="../../assets/images/data-redundancy.png" alt="-" width="550"/>
...
- Azure Data Factory has the following components that work together to provide the platform for data movement and data integration.
  ...
  <img src="../../assets/images/data-factory-components.png" alt="-" width="450"/>
...
- The following diagram shows how unplanned data and streaming data are bulk ingested or unplanned ingested in **Azure Data Lake Storage**.
  ...
  <img src="../../assets/images/data-lake.png" alt="-" width="420"/>
...
- The Azure Synapse Analytics architecture includes a control node and a pool of compute nodes.
  ...
  <img src="../../assets/images/azure-synapse.png" alt="-" width="350"/>
...
- The following illustration shows the Stream Analytics pipeline, and how data is ingested, analyzed, and sent for presentation or action.
  ...
  <img src="../../assets/images/stream-analytics-end-to-end-pipeline.png" alt="-" width="450"/>
...
- Azure offers three hosting options across the compute services.
  ...
  <img src="../../assets/images/host-infrastructures.png" alt="-" width="450"/>

- Azure compute service decision flowchart

  <img src="../../assets/images/compute-flowchart.png" alt="-" width="450"/>

## Application architecture

- Azure Service Bus publish-subscribe topics

  <img src="../../assets/images/service-bus-topic.png" alt="-" width="450"/>
...
1. When a message is read from Event Hubs, it's not deleted. The message remains for other consumers.
  ...
  <img src="../../assets/images/event-hubs-integration.png" alt="-" width="450"/>
...
1. Events are distributed to handlers like Azure Functions and Azure DevOps Webhooks.
  ...
  <img src="../../assets/images/services-integration.png" alt="-" width="450"/>

- Azure Cache for Redis is on a retirement path: new cache creation became unavailable in April 2026 and the service retires in September 2028. Use [Azure Managed Redis](https://learn.microsoft.com/en-us/azure/azure-cache-for-redis/retirement-faq) for new workloads and plan migration of existing caches.
...
- Azure App Configuration provides a service to centrally manage application settings and feature flags. You can use App Configuration to store all the settings for your application and secure their accesses in one place.
  ...
  <img src="../../assets/images/app-config-production.png" alt="-" width="450"/>

- Load Balancing

  <img src="../../assets/images/load-balancer-decision-tree-thumb.png" alt="-" width="650"/>
...
## Azure Well-Architected Framework
  ...
  <img src="../../assets/images/cloud-adoption-framework.png" alt="-" width="450"/>
...
- The following illustration shows the available monitoring services assembled into logical groups.
   ...
   <img src="../../assets/images/3-monitoring-products-overview.png" alt="-" width="250"/>
...
- Azure Monitor
   ...
   <img src="../../assets/images/5-azure-monitor.png" alt="-" width="500"/>
...
- RPO & RTO
    ...
    <img src="../../assets/images/3-rto-rpo.png" alt="-" width="500"/>
...
- Zero Trust model
    ...
    - Security layers
      ...
      <img src="../../assets/images/2-defense-in-depth.png" alt="-" width="200"/>
    ...
    - Shared responsibilities
      ...
      <img src="../../assets/images/2-shared-responsibilities.png" alt="-" width="300"/>

- Synchronize directories with Microsoft Entra Connect Sync

      <img src="../../assets/images/3-azure-ad-connect-2.png" alt="-" width="450"/>
...
- Security Development Lifecycle
      ...
      <img src="../../assets/images/7-security-development-lifecycle.png" alt="-" width="450"/>
...
1. How OKRs add value to an organization
      ...
      <img src="../../assets/images/okr.png" alt="-" width="450"/>
...
- Govern methodology
    ...
    <img src="../../assets/images/methodology.png" alt="-" width="450"/>
...
This diagram depicts the specific organizational functions within security. It represents an ideal view of a complete enterprise security team and might be an aspirational view for some security teams. Each function can be performed by one or more people. Each person can perform one or more functions based on factors like culture, budget, and available resources.
  ...
  <img src="../../assets/images/security-organizational-functions.png" alt="-" width="550"/>

  <img src="../../assets/images/security-roles-responsibilities.png" alt="-" width="550"/>
...
- Several tools and controls are available to help you quickly achieve a security baseline:
  ...
  [Microsoft Entra ID](https://learn.microsoft.com/en-us/entra/fundamentals/new-name): Azure's cloud identity and access management service. Use Microsoft Entra recommendations and identity protection capabilities to assess and improve identity security posture.
  ...
  [Privileged Identity Management (PIM)](https://learn.microsoft.com/en-us/entra/id-governance/privileged-identity-management/pim-configure): A Microsoft Entra capability that enables you to manage, control, and monitor privileged access to important resources.
