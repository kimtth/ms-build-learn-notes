...
- Prefer Bicep for new Azure infrastructure-as-code work. Bicep is a declarative Azure deployment language with type safety, modules, `what-if`, and Azure Resource Manager orchestration. See [Bicep overview](https://learn.microsoft.com/en-us/azure/azure-resource-manager/bicep/overview).
- Azure Blueprints (Preview) is being retired on January 31, 2027; phased retirement began July 31, 2026. Migrate existing definitions to Deployment Stacks or Template Specs and use Bicep, Azure Policy, and Azure RBAC for new governance automation. See [Azure Blueprints retirement guidance](https://learn.microsoft.com/en-us/azure/governance/blueprints/blueprint-retirement).
- For secure delivery, treat identity, secrets, dependency management, code scanning, infrastructure policy, deployment approvals, telemetry, and incident learning as part of the delivery system rather than separate after-the-fact controls.
...
<img src="../../assets/images/devops-cycle-98924900.png" alt="package" width="450"/>
...
1. What does Azure DevOps provide?
    ...
    - Azure Boards
        ...
        <img src="../../assets/images/azure-boards-board-view-78b3f04e.png" alt="package" width="550"/>

        <img src="../../assets/images/azure-boards-delivery-plan-11462b8e.png" alt="package" width="450"/>

    - Github Project boards

        <img src="../../assets/images/github-project-boards-board-80633bf7.png" alt="package" width="550"/>
...
- The State of DevOps Report 2021 highlights version control in almost all stages of DevOps evolution.
    ...
    <img src="../../assets/images/foundational-practices-five-stages-zero-two-5bd71abb.png" alt="package" width="650"/>

    <img src="../../assets/images/foundational-practices-five-stages-tree-five-00bc5230.png" alt="package" width="650"/>
...
- "Code does not exist unless it is committed into source control. Source control is the fundamental enabler of continuous delivery."
    ...
    <img src="../../assets/images/pipeline-phases-808e4101.png" alt="package" width="650"/>
...
- Understand centralized source control
    ...
    <img src="../../assets/images/centralized-strengths-best-used-2b567258.png" width="450"/>
...
- Understand distributed source control
    ...
    <img src="../../assets/images/distributed-strengths-best-used-143d1739.png" width="450"/>
    ...
    <img src="../../assets/images/centralized-distributed-version-control-systems-5627b609.png" width="450"/>
...
- Azure Pipelines combines continuous integration (CI) and continuous delivery (CD) to test and build your code and ship it to any target constantly and consistently.
    ...
    <img src="../../assets/images/cicd.png" width="450"/>
...
- Package formats: To produce packages that others can consume, you can publish NuGet, npm, or Maven packages to the built-in package management repository in Azure Pipelines.
    ...
    <img src="../../assets/images/key-pipeline-concepts-overview-ca80c85c.png" width="450"/>
...
- The agents must have connectivity to the target on-premises environments and access to the Internet to connect to Azure Pipelines or Azure DevOps Server, as shown in the following diagram.
    ...
    <img src="../../assets/images/agents-stages-behind-firewall-ae9c03be.png" width="450"/>
...
- The trunk-based development Workflow assumes a central repository, and the main represents the official project history. Instead of committing directly to their local main branch, developers create a new branch every time they start work on a new feature.
    ...
    <img src="../../assets/images/create-branch-8f64a7d3.png" width="450"/>
...
- Secure workflow defaults: grant `GITHUB_TOKEN` only the permissions each job needs, prefer OpenID Connect for cloud deployments, and pin third-party actions to a full commit SHA in production. A version tag is easier to read but mutable; keep an adjacent version comment and use Dependabot to maintain SHA-pinned actions. Treat `pull_request_target`, `workflow_run`, and self-hosted runners that process untrusted pull requests as privileged-risk scenarios.
...
- **`on`** specifies the event that starts the workflow.
- **`jobs`** defines the build job.
- **`steps`** checks out the code and configures .NET.
- **`run`** executes the build command.
```

> **Production note:** The full commit SHAs in this sample are immutable. Retain the same-line release comments so Dependabot can update them, and grant only the `permissions:` that the workflow needs.
...
- Containers and VMs are similar in their goals: to isolate an application and its dependencies into a self-contained unit that can run anywhere. They remove the need for physical hardware. The main difference between containers and VMs is in their architectural approach.
    ...
    <img src="../../assets/images/container-architecture-d3507692.png" width="450"/>
...
- multi-stage Dockerfiles
    ...
    Use supported .NET images and pin a tested image tag or digest for production builds. Authenticate CI/CD systems to Azure Container Registry through OpenID Connect or managed identity and Microsoft Entra RBAC; avoid the registry admin account except for exceptional, documented scenarios.
...
- The eight principles of continuous delivery:
    ...
    <img src="../../assets/images/continuous-delivery-4e7ce134.png" width="450"/>
...
- A release pipeline takes artifacts and releases them through stages and finally into production.
    ...
    <img src="../../assets/images/pipeline-7793ffc6.png" width="450"/>
...
- Instead of automating all your manual tests into automated UI tests, you need to rethink your testing strategy. As Lisa Crispin describes in her book Agile Testing, you can divide your tests into multiple categories.
    ...
    <img src="../../assets/images/agile-testing-quadrants-1495c244.png" width="450"/>
...
- Blue-green deployment
    ...
    <img src="../../assets/images/blue-green-new-58f05eb7.png" width="450"/>
...
- Canary releases
    ...
    <img src="../../assets/images/canary-release-47d754eb.png" width="450"/>
...
- A/B testing (also known as split testing or bucket testing)
    ...
    <img src="../../assets/images/a-b-test-1e548a4c.png" width="450"/>
...
- The Microsoft Windows team, for example, uses these rings.
    ...
    <img src="../../assets/images/windows-deployment-rings-45ab6434.png" width="450"/>
...
- The general process for how Azure Automation State configuration works is as follows:
    ...
    <img src="../../assets/images/dsc1-127af77c.png" width="450"/>
...
They're handy in providing a single pane of glass over your Azure infrastructure and services allowing you to identify critical issues quickly.
  ...
  <img src="../../assets/images/azure-dashboards-274204b2.png" width="450"/>
...
- Azure DevOps project wikis
  ...
  <img src="../../assets/images/project-wiki-2fd9a459.png" width="450"/>
...
- DevOps is about working faster. Security is about-emphasizing thoroughness. Security concerns are typically addressed at the end of the cycle. It can potentially create unplanned work right at the end of the pipeline. Secure DevOps integrates DevOps with security into a set of practices designed to meet the goals of both DevOps and safety effectively.
  ...
  <img src="../../assets/images/secure-devops-c185814f.png" width="450"/>
...
- Two essential features of Secure DevOps Pipelines that aren't found in standard DevOps Pipelines are:
  ...
  <img src="../../assets/images/secure-devops-workflow-895bcdec.png" width="450"/>
...
- There are five major threat modeling steps: Threat modeling is a core element of the Microsoft Security Development Lifecycle (SDL). It's an engineering technique you can use to help you identify threats, attacks, vulnerabilities, and countermeasures that could affect your application.
   ...
   <img src="../../assets/images/threat-modeling-98beb5cb.png" width="300"/>
...
- "Open-source software is a type of computer software in which source code is released under a license in which the copyright holder grants users the rights to study, change, and distribute the software to anyone and for any purpose."
   ...
   <img src="../../assets/images/open-source-azure-66a7643e.png" width="650"/>
...
- There are multiple licenses used in open-source.
   ...
   <img src="../../assets/images/2-3-license-spectrum-2ef17187.png" width="350"/>
...
- Azure Blueprints is in phased retirement and retires January 31, 2027. Use Bicep to define resources and modules, then combine Azure Policy, Azure RBAC, deployment stacks, and template specs to implement repeatable governance and deployment controls.
